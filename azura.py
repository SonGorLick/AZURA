...
banner1 = """
  ...
  [13] Token Gen         [14] Token Finder
  [15] Half Token Find   [16] Email Spammer
  [17] TokenLogger Build [18] tukz
"""
def main():
  pass
...
if choice == 1:
  ...
  print("Some ideas generated by tukz brain")
  time.sleep(5)
...
if choice == 13:
  ...
  success = colorama.Fore.LIGHTGREEN_EX + " [" + colorama.Fore.RESET + "v" + colorama.Fore.GREEN + "] " + colorama.Fore.RESET
...
def register(token):
    ...
    mail = ("".join(random.SystemRandom().choice(string.ascii_lowercase + string.digits)for _ in range(12))) + random.choice(["@azura.com", "@azurafakemail.com", "@azuratemp2.net","@azurazeemail.xyz"])
...
def name():
    while True:
        time.sleep(0.1)
        os.system(f"title   AZURAGEN Generated: {str(Stats.gened)} SOLVED: {str(Stats.solved)}")
...
print(Colorate.Horizontal(Colors.green_to_blue, Center.XCenter(banner)))
print("\n")
choice = (input(f"                                      {Colors.green} [+] CAPTCHA KEY > "))
time.sleep(2)
print("\n                                       [+] KEY IS VALID")
print("")
time.sleep(1)
choice = (input(f"                                      {Colors.green} [+] THREADS > "))
time.sleep(1)
